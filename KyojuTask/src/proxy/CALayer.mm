...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.CoreGraphics.CGColorRef} __return = #{iOS.QuartzCore.CALayer:Of(__this).backgroundColor():Call()};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.QuartzCore.CALayer:Of(__this).setBackgroundColor(iOS.CoreGraphics.CGColorRef):Call((#{iOS.CoreGraphics.CGColorRef})(size_t) backgroundColor)};
//}
//#endif // !IsStripped
