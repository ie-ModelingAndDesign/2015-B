...
// {
::g::iOS::Foundation::NSObject_type* UIImagePickerController_typeof()
{
    ...
    type = (::g::iOS::Foundation::NSObject_type*)uClassType::New("iOS.UIKit.UIImagePickerController", options);
