// This file was generated based on '/Users/shintarooo0079/Desktop/MyFirstProject/.uno/Kono.g.uno'.
...
// public partial sealed class Kono :1
// {
// static Kono() :3
static void Kono__cctor_5_fn(uType* __type)
{
}

::g::Fuse::Controls::ParentControl_type* Kono_typeof()
{
    ...
    options.ObjectSize = sizeof(Kono);
    options.TypeSize = sizeof(::g::Fuse::Controls::ParentControl_type);
    type = (::g::Fuse::Controls::ParentControl_type*)uClassType::New("Kono", options);
    type->SetBase(::g::Fuse::Controls::Panel_typeof());
    type->fp_ctor_ = (void*)Kono__New3_fn;
    type->fp_cctor_ = Kono__cctor_5_fn;
...
// public Kono() :6
void Kono__ctor_5_fn(Kono* __this)
{
    __this->ctor_5();
}

// private void InitializeUX() :10
void Kono__InitializeUX_fn(Kono* __this)
{
    __this->InitializeUX();
}

// public Kono New() :6
void Kono__New3_fn(Kono** __retval)
{
    *__retval = Kono::New3();
}

// public Kono() [instance] :6
void Kono::ctor_5()
{
    ctor_4();
    InitializeUX();
...
void Kono::InitializeUX()
{
    ::g::Fuse::Controls::Image* temp = ::g::Fuse::Controls::Image::New2();
    Width(300.0f);
    Height(300.0f);
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::MyFirstProject_bundle::konoba7ceea4()));
...
// public Kono New() [static] :6
Kono* Kono::New3()
{
    Kono* obj1 = (Kono*)uNew(Kono_typeof());
    obj1->ctor_5();
    return obj1;
}
// }
