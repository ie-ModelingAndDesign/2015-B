...
// {
// static Okazaki() :3
static void Okazaki__cctor_5_fn(uType* __type)
{
}
...
::g::Fuse::Controls::ParentControl_type* Okazaki_typeof()
{
    ...
    options.ObjectSize = sizeof(Okazaki);
    options.TypeSize = sizeof(::g::Fuse::Controls::ParentControl_type);
    type = (::g::Fuse::Controls::ParentControl_type*)uClassType::New("Okazaki", options);
    type->SetBase(::g::Fuse::Controls::Panel_typeof());
    type->fp_ctor_ = (void*)Okazaki__New3_fn;
    type->fp_cctor_ = Okazaki__cctor_5_fn;
...
// public Okazaki New() :6
void Okazaki__New3_fn(Okazaki** __retval)
{
    *__retval = Okazaki::New3();
}

// public Okazaki() [instance] :6
void Okazaki::ctor_5()
{
    ctor_4();
    InitializeUX();
...
void Okazaki::InitializeUX()
{
    ::g::Fuse::Controls::Image* temp = ::g::Fuse::Controls::Image::New2();
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::MyFirstProject_bundle::okazaki517d0799()));
...
// public Okazaki New() [static] :6
Okazaki* Okazaki::New3()
{
    Okazaki* obj1 = (Okazaki*)uNew(Okazaki_typeof());
    obj1->ctor_5();
    return obj1;
}
// }
