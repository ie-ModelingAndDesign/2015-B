...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.WebKit.WKWebView:Of(__this).initWithCoder(iOS.Foundation.NSCoder):Call((#{iOS.Foundation.NSCoder})uObjC::Lifetime::GetUnoObject(coder, #{iOS.Foundation.NSCoder:TypeOf}))};
//    return uObjC_OBJECT_HANDLE(__this);
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{string} __return = #{iOS.WebKit.WKWebView:Of(__this).title():Call()};
