...
// public partial sealed class CloseIcon :1
// {
// static CloseIcon() :22
static void CloseIcon__cctor_5_fn(uType* __type)
{
}

::g::Fuse::Controls::ParentControl_type* CloseIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(CloseIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::ParentControl_type);
    type = (::g::Fuse::Controls::ParentControl_type*)uClassType::New("CloseIcon", options);
    type->SetBase(::g::Fuse::Controls::Panel_typeof());
    type->fp_ctor_ = (void*)CloseIcon__New3_fn;
    type->fp_cctor_ = CloseIcon__cctor_5_fn;
...
// public CloseIcon() :25
void CloseIcon__ctor_5_fn(CloseIcon* __this)
{
    __this->ctor_5();
}

// private void InitializeUX() :29
void CloseIcon__InitializeUX_fn(CloseIcon* __this)
{
    __this->InitializeUX();
}

// public CloseIcon New() :25
void CloseIcon__New3_fn(CloseIcon** __retval)
{
    *__retval = CloseIcon::New3();
}

// public CloseIcon() [instance] :25
void CloseIcon::ctor_5()
{
    ctor_4();
    InitializeUX();
}
...
// public CloseIcon New() [static] :25
CloseIcon* CloseIcon::New3()
{
    CloseIcon* obj2 = (CloseIcon*)uNew(CloseIcon_typeof());
    obj2->ctor_5();
    return obj2;
}
// }
