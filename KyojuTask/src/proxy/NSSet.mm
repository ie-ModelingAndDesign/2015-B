...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.Foundation.NSSet:Of(__this).addObserverForKeyPathOptionsContext(iOS.Foundation.NSObject,string,iOS.Foundation.NSKeyValueObservingOptions,Uno.IntPtr):Call((#{iOS.Foundation.NSObject})uObjC::Lifetime::GetUnoObject(observer, #{iOS.Foundation.NSObject:TypeOf}), uObjC::UnoString(keyPath), #{uint}(options), (#{Uno.IntPtr})context)};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.Foundation.NSSet:Of(__this).removeObserverForKeyPathContext(iOS.Foundation.NSObject,string,Uno.IntPtr):Call((#{iOS.Foundation.NSObject})uObjC::Lifetime::GetUnoObject(observer, #{iOS.Foundation.NSObject:TypeOf}), uObjC::UnoString(keyPath), (#{Uno.IntPtr})context)};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.Foundation.NSSet:Of(__this).removeObserverForKeyPath(iOS.Foundation.NSObject,string):Call((#{iOS.Foundation.NSObject})uObjC::Lifetime::GetUnoObject(observer, #{iOS.Foundation.NSObject:TypeOf}), uObjC::UnoString(keyPath))};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{ObjC.ID} __return = #{iOS.Foundation.NSSet:Of(__this).valueForKey(string):Call(uObjC::UnoString(key))};
//    return (::id)__return;
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.Foundation.NSSet:Of(__this).setValueForKey(ObjC.ID,string):Call((#{ObjC.ID})value, uObjC::UnoString(key))};
//}
//#endif // !IsStripped
