...
{
    FuseBasicTheme_bundle::RobotoLight3e27d112_ = ::g::Uno::BundleFile::New1(::STRINGS[0/*"roboto-ligh...*/]);
    FuseBasicTheme_bundle::RobotoMediumf972a8c1_ = ::g::Uno::BundleFile::New1(::STRINGS[1/*"roboto-medi...*/]);
    FuseBasicTheme_bundle::RobotoRegular98daa298_ = ::g::Uno::BundleFile::New1(::STRINGS[2/*"roboto-regu...*/]);
}
...
uClassType* FuseBasicTheme_bundle_typeof()
{
    ...
    ::STRINGS[0] = uString::Const("roboto-light-c9be3551.ttf");
    ::STRINGS[1] = uString::Const("roboto-medium-138fb00a.ttf");
    ::STRINGS[2] = uString::Const("roboto-regular-f5456817.ttf");
    type->SetFields(0,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseControlsButton_string_Text_Property_typeof()
{
    ...
    ::TYPES[2] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(2,
...
void FuseBasicTheme_FuseControlsButton_string_Text_Property::ctor_1(::g::Fuse::Controls::Button* obj)
{
    ctor_();
    _obj = obj;
    uPtr(obj)->add_TextChanged(uDelegate::New(::TYPES[2/*Uno.UX.ValueChangedHandler<string>*/], (void*)::g::Uno::UX::Property__OnValueChanged_fn, this));
}
...
void FuseBasicTheme_FuseControlsTextControl_string_Value_Property::ctor_1(::g::Fuse::Controls::TextControl* obj)
{
    ctor_();
    _obj = obj;
    uPtr(obj)->add_ValueChanged(uDelegate::New(::TYPES[2/*Uno.UX.ValueChangedHandler<string>*/], (void*)::g::Uno::UX::Property__OnValueChanged_fn, this));
}
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseControlsTextEdit_float4_PlaceholderColor_Property_typeof()
{
    ...
    ::TYPES[4] = ::g::Fuse::Controls::TextEdit_typeof();
    type->SetFields(2,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseDrawingStroke_float_Width_Property_typeof()
{
    ...
    ::TYPES[6] = ::g::Fuse::Drawing::Stroke_typeof();
    type->SetFields(2,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseEffectsDropShadow_float4_Color_Property_typeof()
{
    ...
    ::TYPES[7] = ::g::Fuse::Effects::DropShadow_typeof();
    type->SetFields(2,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseTranslation_float_X_Property_typeof()
{
    ...
    ::TYPES[9] = ::g::Fuse::Translation_typeof();
    type->SetFields(2,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseTriggersActionsTriggerAction_bool_IsActive_Property_typeof()
{
    ...
    ::TYPES[10] = ::g::Fuse::Triggers::Actions::TriggerAction_typeof();
    type->SetFields(2,
...
::g::Uno::UX::Property_type* FuseBasicTheme_FuseTriggersWhileBool_bool_Value_Property_typeof()
{
    ...
    ::TYPES[11] = ::g::Fuse::Triggers::WhileBool_typeof();
    type->SetFields(2,
...
{
    FuseControls_bundle::ImageElementDraw0b0922af_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[3/*"uniform mat...*/], ::STRINGS[4/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 7, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseControls_bundle::SolidRectangleafb52825_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[12/*"uniform mat...*/], ::STRINGS[13/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 13, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[19/*"n"*/]));
    FuseControls_bundle::SolidRectangleafb52826_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[20/*"uniform mat...*/], ::STRINGS[21/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 4, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/]));
    FuseControls_bundle::SolidRectangleafb52827_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[22/*"uniform mat...*/], ::STRINGS[23/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[18/*"l"*/]));
    FuseControls_bundle::Viewportb83477c3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[24/*"uniform mat...*/], ::STRINGS[25/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 4, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/]));
}
...
uClassType* FuseControls_bundle_typeof()
{
    ...
    ::STRINGS[3] = uString::Const("uniform mat4 f, b;\n"
        "uniform vec2 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[4] = uString::Const("uniform vec4 e;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
    ...
    ::STRINGS[12] = uString::Const("uniform mat4 l, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[13] = uString::Const("uniform vec4 i;\n"
        "uniform float j, k;\n"
        "\n"
        "uniform sampler2D n;\n"
        "\n"
    ...
    ::STRINGS[20] = uString::Const("uniform mat4 d, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[21] = uString::Const("uniform vec4 c;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = c;\n"
...
{
    FuseCore_bundle::DrawHelpersbba46184_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[26/*"uniform vec...*/], ::STRINGS[27/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/]));
    FuseCore_bundle::OpenSansLight957c354d_ = ::g::Uno::BundleFile::New1(::STRINGS[28/*"opensans-li...*/]);
}
...
uClassType* FuseCore_bundle_typeof()
{
    ...
    ::STRINGS[8] = uString::Const("d");
    ::STRINGS[9] = uString::Const("e");
    ::STRINGS[28] = uString::Const("opensans-light-eaf1b13e.ttf");
    ::TYPES[12] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
...
{
    FuseDrawing_bundle::LinearGradientDrawable066bc6f3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[29/*"attribute v...*/], ::STRINGS[30/*"uniform flo...*/], 2, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 6, ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[5/*"a"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/]));
}
...
uClassType* FuseDrawing_bundle_typeof()
{
    ...
    ::STRINGS[29] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[30] = uString::Const("uniform float d[b], e;\n"
        "uniform vec4 f[c];\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
...
{
    FuseDrawingPolygons_bundle::Borderabeb3b3d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[31/*"uniform mat...*/], ::STRINGS[32/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[33/*"m"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b3e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[34/*"uniform mat...*/], ::STRINGS[35/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 4, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b3f_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[36/*"uniform mat...*/], ::STRINGS[37/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 9, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPolygons_bundle::Borderabeb3b40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform mat...*/], ::STRINGS[39/*"varying vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 3, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[40/*"uniform mat...*/], ::STRINGS[41/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[18/*"l"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[42/*"uniform mat...*/], ::STRINGS[21/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 3, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/]));
    FuseDrawingPolygons_bundle::PolygonDrawablefeed06e9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[43/*"uniform mat...*/], ::STRINGS[44/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 9, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[16/*"j"*/]));
}
...
uClassType* FuseDrawingPolygons_bundle_typeof()
{
    ...
    ::STRINGS[31] = uString::Const("uniform mat4 c;\n"
        "uniform vec2 d, e, f, g, h;\n"
        "\n"
        "attribute vec4 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[32] = uString::Const("uniform vec4 i;\n"
        "uniform float j;\n"
        "\n"
        "uniform sampler2D m;\n"
        "\n"
    ...
    ::STRINGS[15] = uString::Const("i");
    ::STRINGS[16] = uString::Const("j");
    ::STRINGS[33] = uString::Const("m");
    ::STRINGS[34] = uString::Const("uniform mat4 b;\n"
        "uniform vec4 c;\n"
        "uniform float d;\n"
        "\n"
        "attribute vec4 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[35] = uString::Const("varying vec4 e;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = e;\n"
    ...
    ::STRINGS[36] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[37] = uString::Const("uniform float f;\n"
        "\n"
        "uniform sampler2D k;\n"
        "\n"
        "varying vec4 i;\n"
    ...
    ::STRINGS[38] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[39] = uString::Const("varying vec4 d;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = d;\n"
        "}\n"
        "");
    ::STRINGS[40] = uString::Const("uniform mat4 c;\n"
        "uniform vec2 d, e, f, g, h;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[41] = uString::Const("uniform vec4 i;\n"
        "uniform float j;\n"
        "\n"
        "uniform sampler2D l;\n"
        "\n"
    ...
    ::STRINGS[43] = uString::Const("uniform mat4 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[44] = uString::Const("uniform float f;\n"
        "\n"
        "uniform sampler2D j;\n"
        "\n"
        "varying float i;\n"
...
{
    FuseDrawingPrimitives_bundle::Circle2a09f04b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"uniform vec...*/], ::STRINGS[46/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 19, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[51/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle2a09f04c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"uniform vec...*/], ::STRINGS[52/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 19, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[51/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle2a09f04d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[53/*"uniform vec...*/], ::STRINGS[54/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 16, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[50/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d6b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[55/*"uniform vec...*/], ::STRINGS[56/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 13, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d6c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[55/*"uniform vec...*/], ::STRINGS[57/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 13, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circle2a0b4d82_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[58/*"uniform vec...*/], ::STRINGS[59/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 10, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[60/*"uniform vec...*/], ::STRINGS[61/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 17, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[62/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[60/*"uniform vec...*/], ::STRINGS[63/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 17, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[62/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle2a16366d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[65/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 14, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[48/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[67/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 12, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[68/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 12, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle2a17938d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[69/*"uniform vec...*/], ::STRINGS[70/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 9, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/]));
    FuseDrawingPrimitives_bundle::Circle32dc887c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[71/*"uniform vec...*/], ::STRINGS[72/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 19, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[51/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle32dc887d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[74/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 16, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[50/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[75/*"uniform vec...*/], ::STRINGS[76/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 21, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[62/*"s"*/], ::STRINGS[77/*"t"*/], ::STRINGS[78/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[75/*"uniform vec...*/], ::STRINGS[79/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 21, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[62/*"s"*/], ::STRINGS[77/*"t"*/], ::STRINGS[78/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c424c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[80/*"uniform vec...*/], ::STRINGS[81/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 18, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[77/*"t"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d90_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[82/*"uniform vec...*/], ::STRINGS[83/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 15, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d91_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[82/*"uniform vec...*/], ::STRINGS[84/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 15, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c4d92_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[85/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 12, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle7f4c58d6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[71/*"uniform vec...*/], ::STRINGS[86/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 19, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[51/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[87/*"uniform vec...*/], ::STRINGS[88/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 14, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[87/*"uniform vec...*/], ::STRINGS[89/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 14, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circlef0db6dc6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[90/*"uniform vec...*/], ::STRINGS[91/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5eefb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[92/*"uniform flo...*/], ::STRINGS[93/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 20, ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[50/*"r"*/], ::STRINGS[62/*"s"*/], ::STRINGS[94/*"x"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5eefc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[95/*"uniform flo...*/], ::STRINGS[96/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 14, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5eefd_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[97/*"uniform flo...*/], ::STRINGS[98/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 18, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[99/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5eefe_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[100/*"uniform flo...*/], ::STRINGS[101/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 13, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5fe03_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[102/*"uniform flo...*/], ::STRINGS[103/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 18, ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[49/*"q"*/], ::STRINGS[99/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5fe04_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[104/*"uniform flo...*/], ::STRINGS[105/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 12, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5fe05_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[106/*"uniform flo...*/], ::STRINGS[107/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 16, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[77/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle35a5fe06_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[108/*"uniform flo...*/], ::STRINGS[109/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/]));
}
...
uClassType* FuseDrawingPrimitives_bundle_typeof()
{
    ...
    ::STRINGS[45] = uString::Const("uniform vec2 c, d, f, g, h, i, j;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[46] = uString::Const("uniform vec4 k;\n"
    ...
    ::STRINGS[33] = uString::Const("m");
    ::STRINGS[19] = uString::Const("n");
    ::STRINGS[47] = uString::Const("o");
    ::STRINGS[48] = uString::Const("p");
    ::STRINGS[49] = uString::Const("q");
    ::STRINGS[50] = uString::Const("r");
    ::STRINGS[51] = uString::Const("u");
    ::STRINGS[52] = uString::Const("uniform vec4 k;\n"
        "uniform float l, m, n, o;\n"
        "uniform vec2 p, q, r;\n"
        "\n"
        "uniform sampler2D u;\n"
        ...
        "}\n"
        "");
    ::STRINGS[53] = uString::Const("uniform vec2 c, d, f, g, h, i, j;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::STRINGS[55] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[56] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[57] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
    ...
    ::STRINGS[59] = uString::Const("uniform float e, f, g, h, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[60] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[61] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec2 n, o, p;\n"
        "\n"
        "uniform sampler2D s;\n"
        "\n"
    ...
    ::STRINGS[66] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[67] = uString::Const("uniform float e, f, g, h;\n"
        "uniform vec2 j, k, l;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[68] = uString::Const("uniform float e, f, g, h;\n"
        "uniform vec2 j, k, l;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 m;\n"
    ...
    ::STRINGS[74] = uString::Const("uniform float h, i, j, k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[75] = uString::Const("uniform vec2 c, d, f, g, h, i, j;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[76] = uString::Const("uniform vec4 k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[77] = uString::Const("t");
    ::STRINGS[78] = uString::Const("w");
    ...
    ::STRINGS[82] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[83] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[84] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
    ...
    ::STRINGS[86] = uString::Const("uniform float h, i, j, k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[87] = uString::Const("uniform vec2 b, c;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::STRINGS[88] = uString::Const("uniform float e, f, g, h, i, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[89] = uString::Const("uniform float e, f, g, h, i, j;\n"
        "uniform vec2 l, m, n;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 o;\n"
    ...
    ::STRINGS[91] = uString::Const("uniform float e, f, g, h, i, j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[92] = uString::Const("uniform float f[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[93] = uString::Const("uniform vec4 n;\n"
    ...
    ::STRINGS[95] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[96] = uString::Const("uniform float h, i, j, k, l, n;\n"
        "uniform vec3 m;\n"
        "\n"
        "varying float o;\n"
        "varying vec2 p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[97] = uString::Const("uniform float e[d], q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[98] = uString::Const("uniform float k, l, m, n, o;\n"
        "\n"
        "uniform sampler2D v;\n"
        "\n"
        "varying float r, s;\n"
    ...
    ::STRINGS[104] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[105] = uString::Const("uniform float h, i, j, l;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float m;\n"
        "varying vec2 n, o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[106] = uString::Const("uniform float e[d], o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[107] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[108] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[109] = uString::Const("uniform float h, i, j;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
...
{
    FuseEffects_bundle::Blitter1ef54105_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[110/*"uniform mat...*/], ::STRINGS[111/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 7, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::Blurec489e30_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[112/*"uniform mat...*/], ::STRINGS[113/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 4, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[9/*"e"*/]));
    FuseEffects_bundle::Desaturatec68ecebc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[114/*"uniform mat...*/], ::STRINGS[115/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[10/*"f"*/]));
    FuseEffects_bundle::EffectHelpers19f0dc38_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[116/*"attribute v...*/], ::STRINGS[117/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 2, ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/]));
    FuseEffects_bundle::EffectHelpers36c238d5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[118/*"uniform vec...*/], ::STRINGS[119/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 8, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[33/*"m"*/]));
    FuseEffects_bundle::EffectHelpers4273de51_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[120/*"uniform vec...*/], ::STRINGS[121/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 11, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[77/*"t"*/]));
    FuseEffects_bundle::EffectHelpersde6318b0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[122/*"attribute v...*/], ::STRINGS[123/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 7, ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[5/*"a"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::Halftoneb6f474d8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[124/*"uniform mat...*/], ::STRINGS[125/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 14, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[49/*"q"*/]));
    FuseEffects_bundle::Mask76ebab4c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform mat...*/], ::STRINGS[127/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/]));
    FuseEffects_bundle::Mask76ebab4d_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform mat...*/], ::STRINGS[128/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/]));
    FuseEffects_bundle::Mask76ebab4e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[126/*"uniform mat...*/], ::STRINGS[129/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/]));
}
...
uClassType* FuseEffects_bundle_typeof()
{
    ...
    ::STRINGS[110] = uString::Const("uniform mat4 f, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        ...
        "}\n"
        "");
    ::STRINGS[111] = uString::Const("uniform vec3 e;\n"
        "uniform float c, d;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
    ...
    ::STRINGS[10] = uString::Const("f");
    ::STRINGS[11] = uString::Const("h");
    ::STRINGS[112] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[113] = uString::Const("uniform sampler2D e;\n"
        "\n"
        "varying vec2 d;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[114] = uString::Const("uniform mat4 d, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[115] = uString::Const("uniform float c;\n"
        "\n"
        "uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
    ...
    ::STRINGS[14] = uString::Const("g");
    ::STRINGS[33] = uString::Const("m");
    ::STRINGS[120] = uString::Const("uniform vec2 c, e, f, h, i, j;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[121] = uString::Const("uniform float b, d, g;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying vec2 k, l, m, n, o, p, q, r, s;\n"
    ...
    ::STRINGS[123] = uString::Const("uniform float e[b];\n"
        ...
        "}\n"
        "");
    ::STRINGS[124] = uString::Const("uniform mat4 m, b;\n"
        "uniform vec2 g, h;\n"
        "uniform mat2 i;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[125] = uString::Const("uniform float c, d, e, f, k, l;\n"
        "uniform mat2 j;\n"
        "\n"
        "uniform sampler2D q;\n"
        "\n"
    ...
    ::STRINGS[126] = uString::Const("uniform mat4 c, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[127] = uString::Const("uniform sampler2D f, g;\n"
        "\n"
        "varying vec2 d, e;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[128] = uString::Const("uniform sampler2D f, g;\n"
        "\n"
        "varying vec2 d, e;\n"
        "\n"
        "void main()\n"
...
{
    FuseElements_bundle::CacheHelper09c90965_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[130/*"uniform vec...*/], ::STRINGS[131/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 6, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[14/*"g"*/]));
    FuseElements_bundle::ElementBatch47d0cb7a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[132/*"uniform mat...*/], ::STRINGS[133/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[12/*string[]*/], 4, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[10/*"f"*/]));
    FuseElements_bundle::Scale9Rectangle3a507581_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[134/*"uniform flo...*/], ::STRINGS[135/*"uniform vec...*/], 0, 2, uArray::Init<uString*>(::TYPES[12/*string[]*/], 17, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[48/*"p"*/], ::STRINGS[50/*"r"*/]));
}
...
uClassType* FuseElements_bundle_typeof()
{
    ...
    ::STRINGS[130] = uString::Const("uniform vec2 b;\n"
        "uniform mat4 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[131] = uString::Const("uniform float e;\n"
        "\n"
        "uniform sampler2D g;\n"
        "\n"
        "varying vec2 f;\n"
    ...
    ::STRINGS[133] = uString::Const("uniform sampler2D f;\n"
        ...
        "");
    ::STRINGS[10] = uString::Const("f");
    ::STRINGS[134] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        "uniform mat4 i, j;\n"
        "uniform vec2 o;\n"
        "\n"
        "attribute vec3 a, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[135] = uString::Const("uniform vec4 p;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
        "varying vec2 q;\n"
...
{
    FuseiOS_bundle::Blittera700cac2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[136/*"uniform vec...*/], ::STRINGS[137/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[10/*"f"*/]));
}
...
uClassType* FuseiOS_bundle_typeof()
{
    ...
    ::STRINGS[136] = uString::Const("uniform vec2 c, b;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[137] = uString::Const("uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
        "\n"
        "void main()\n"
...
{
    FuseThemes_bundle::RobotoRegular652cfd27_ = ::g::Uno::BundleFile::New1(::STRINGS[2/*"roboto-regu...*/]);
}
...
{
    FuseVideo_bundle::Scale9Rectangle6dee3bb8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[152/*"uniform flo...*/], ::STRINGS[153/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[12/*string[]*/], 16, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[14/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[15/*"i"*/], ::STRINGS[16/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[18/*"l"*/], ::STRINGS[33/*"m"*/], ::STRINGS[19/*"n"*/], ::STRINGS[47/*"o"*/], ::STRINGS[49/*"q"*/]));
    FuseVideo_bundle::VideoDrawElement2ead3e8c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[154/*"uniform mat...*/], ::STRINGS[155/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[12/*string[]*/], 7, ::STRINGS[6/*"b"*/], ::STRINGS[5/*"a"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
uClassType* FuseVideo_bundle_typeof()
{
    ...
    ::STRINGS[152] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[153] = uString::Const("uniform sampler2D q;\n"
        "\n"
        "varying vec2 p;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[154] = uString::Const("uniform mat4 f, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[155] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
...
// public delegate void StopwatchTickHandler() :90
uDelegateType* StopwatchTickHandler_typeof()
{
    static uSStrong<uDelegateType*> type;
    if (type != NULL) return type;

    type = uDelegateType::New("StopwatchTickHandler", 0, 0);
...
{
    UnoCore_bundle::SdfFontShader06541a00_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[156/*"uniform mat...*/], ::STRINGS[157/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 7, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[9/*"e"*/], ::STRINGS[10/*"f"*/], ::STRINGS[15/*"i"*/]));
    UnoCore_bundle::SpriteFontShaderf730f5ae_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[158/*"uniform mat...*/], ::STRINGS[159/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[12/*string[]*/], 5, ::STRINGS[5/*"a"*/], ::STRINGS[6/*"b"*/], ::STRINGS[7/*"c"*/], ::STRINGS[8/*"d"*/], ::STRINGS[14/*"g"*/]));
}
